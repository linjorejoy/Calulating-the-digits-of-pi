...
6. **Ramanujan's Method** : Srinivasa Ramanujan's Method using Modular arithmetic
    <details>
    <summary>Click to view Formula</summary>
...
7. **Spigot Algorithm** : Spigot Algorithm
    <details>
    <summary>Click to view Formula</summary>
...
8. **Half-area of a circle** : Definite Integrals : from half-area of a circle
    <details>
    <summary>Click to view Formula</summary>
...
10. **From Known Identity Of Inverse Trignometric Function**
    <details>
    <summary>Click to view Formula</summary>
       <img src="https://latex.codecogs.com/svg.latex?\Large&space;\frac{\pi}{4}=\tan^{-1}(1)=\int_{0}^{1}\frac{1}{1+x^2}dx"/>
    </details>

11. **BBP formula( Bailey–Borwein–Plouffe formula)-I** : 
    <details>
    <summary>Click to view Formula</summary>
...
12. **BBP formula( Bailey–Borwein–Plouffe formula)-II**: A rapidly converging BBP-type formula found by **F. Bellard**
    <details>
    <summary>Click to view Formula</summary>
...
13. **Viète's formula** : infinite product of nested radicals named after **François Viète**
    <details>
    <summary>Click to view Formula</summary>
...
14. **Basel Problem and Reiman Zeta Function** : This appears when integrating Planck's law to derive the Stefan–Boltzmann law in physics.[Referance](https://en.wikipedia.org/wiki/Riemann_zeta_function "Riemann zeta function")
    <details>
    <summary>Click to view Formula</summary>
      <img src="https://latex.codecogs.com/svg.latex?\dpi{800}\Large&space;\frac{\pi^4}{90}=\frac{1}{1^4}+\frac{1}{2^4}+\frac{1}{3^4}+\frac{1}{4^4}+...."/>
    </details>

15. **Gregory-Leibniz Series - I** :  Gregory-Leibniz Series
    <details>
    <summary>Click to view Formula</summary>
      <img src="https://latex.codecogs.com/svg.latex?\Large&space;\frac{\pi}{4}=1-\frac{1}{3}+\frac{1}{5}-\frac{1}{7}+\frac{1}{9}.....">
    </details>

16. **Gregory-Leibniz Series - II** :  Gregory-Leibniz Series
    <details>
    <summary>Click to view Formula</summary>
...
17. **Gregory-Leibniz Series - III** :  Gregory-Leibniz Series
    <details>
    <summary>Click to view Formula</summary>
...
18. **Gregory-Leibniz Series - IV** :  Gregory-Leibniz Series
    <details>
    <summary>Click to view Formula</summary>
